...
// DbContext (PostgreSQL via Npgsql) com resiliência a falhas e tempos de espera mais curtos para falhar rápido
var connStr = builder.Configuration["SUPABASE_DB_CONNECTION"]; // prefira variável de ambiente/config segura
builder.Services.AddDbContext<PIMContext>(options =>
    options.UseNpgsql(connStr, npgsql =>
    {
        // Tentativas automáticas em falhas transitórias de rede
