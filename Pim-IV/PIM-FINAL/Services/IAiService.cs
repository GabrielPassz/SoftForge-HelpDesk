...
// IAiService/RapidAiService: abstrai chamadas a API (RapidAPI) para classificação, resposta inicial, resumo e extração de palavras-chave. Inclui fallback e normalização.
namespace PIM_FINAL.Services
{
    ...
    public class RapidAiService : IAiService
    {
        ...
        // Records usados para serialização de request
        ...
        // ChatAsync: envia prompt ao endpoint e tenta extrair texto de campos conhecidos (result/answer/etc) ou retorna vazio em erro
        ...
        // ClassifyAsync: pede categoria/prioridade e normaliza resultado tentando mapear sinônimos
...
Descrição: {descricao}";
        ...
        // SuggestInitialReplyAsync: gera resposta inicial curta e empática
        ...
        // SummarizeAsync: produz bullets de resumo
        ...
        // ExtractKeywordsAsync: extrai palavras-chave separadas por vírgulas
